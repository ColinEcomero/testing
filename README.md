...
- Preview: https://main--testing--ColinEcomero.hlx.page/
- Live: https://main--testing--ColinEcomero.hlx.live/
...
1. Open the `testing` directory in your favorite IDE and start coding :)
